...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            # Hash the password with the set_password and update the user object.
            ...
            # If the user provided a profile picture, we need to get it from
...
def user_login(request):
    ...
    if request.method == 'POST':
        # Gather the username and password (from the login form)
...
# Use login_required() decorator to ensure
